...
export default function StJude() {
  ...
  return (
    <div>
      <div
        ...
        style={{
          backgroundImage: "url('/assets/images/st-jude.jpg')",
      ...
      >
        ...
        <div className="relative flex flex-col gap-5 my-2 w-1/2">
          ...
          <p className="text-white text-5xl font-bold leading-tight animate-grow">
            Defeating childhood cancer and other <br /> life-threatening <br />
            diseases
          </p>
          <div className="flex gap-5 animate-grow">
            ...
            <div className="flex flex-col gap-6 text-white font-medium">
              ...
              <p>
                Researchers and doctors work together to turn laboratory
                breakthroughs into lifesaving treatments for children from
                across the United States and around the world.
              </p>
              <p>
                And with your support, St. Jude can provide cutting-edge
                treatments at no cost to families — so they can focus on helping
                their child live.
              </p>
            </div>
          </div>
        </div>
        <div className="relative flex flex-col gap-4 bg-white px-16 py-20 rounded-md  w-1/2 animate-slideInFromRight">
          ...
          <p className="text-sm text-[#6F7775] leading-[2]">
            Unlike other hospitals, the majority of funding comes from generous
            donors. Families never receive a bill from St. Jude for treatment,
            travel, housing or food. Your order goes towards offsetting these
