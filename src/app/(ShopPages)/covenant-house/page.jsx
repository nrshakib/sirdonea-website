...
export default function ConvenantHouse() {
  ...
  return (
    <div>
      <div
        ...
        style={{
          backgroundImage: "url('/assets/images/covenant.jpg')",
      ...
      >
        ...
        {/* Content */}
        <div className="relative flex flex-col gap-5 my-10 w-1/2 px-10">
          <p className="text-[#ECA319] font-semibold text-xl">Covenant House</p>
          <p className="text-white text-5xl font-bold leading-[60px]">
            Share Your Heart. Shine a Light. Until Everyone Has a Home
          </p>
          <div className="flex gap-5">
            <hr className="w-2 h-56 border-0 bg-yellow-400" />
            <div className="flex flex-col gap-2 text-white font-medium">
              <p>
                Covenant House is the largest, primarily privately funded
                charity in North and Central America providing immediate and
                long-term support for young people facing homelessness and
                survivors of trafficking.
              </p>
              <p>
                Since 1972, Covenant House has opened its doors to over 1.5
                million young people experiencing homelessness and trafficking,
                one youth at a time.
              </p>
            </div>
          </div>
        </div>
        <div className="relative flex flex-col gap-4 bg-white px-16 py-20 rounded-md my-20 w-1/2">
          <p className="bg-[#009368] text-white px-3 py-2 mb-8 rounded-md w-40 font-semibold text-center">
            Homelessness
          </p>
          <p className="text-3xl font-bold text-[#213430]">
            Empower young people to rise and overcome adversity.
          </p>
          <p className="text-sm text-[#6F7775]">
            Provide housing and support services to youth facing homelessness.
            We help young people transform their lives and put them on a path to
            independence.
          </p>
          <div className="mt-4">
            ...
            <div className="w-full bg-gray-200 rounded-full h-6 my-2">
              {/* <div
                ...
                style={{ width: products.length > 0 ? "40%" : "0%" }}
              >
                <p>$400</p>
                <p className="text-white font-semibold">46%</p>
              </div> */}
            </div>
          </div>
        </div>
      ...
      <div>
        <div
          ...
          style={{
            background: "url('/assets/images/Get Start/bg_banner.png')",
          }}
        >
          <div>
