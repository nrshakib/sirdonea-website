  ...
  return (
    <div>
      <div
        ...
        style={{
          backgroundImage: "url('/assets/images/aspca.jpg')",
      ...
      >
        ...
        <div className="relative flex flex-col gap-5 my-2 w-1/2">
          <p className="text-[#ECA319] font-semibold text-xl">ASPCA</p>
          <p className="text-white text-5xl font-bold leading-tight text-left">
            The forefront of animal rescue and protection for over 150 years
          </p>
          <div className="flex gap-5">
            <hr className="w-2 h-44 border-0 bg-yellow-400" />
            <div className="flex flex-col gap-6 text-white font-medium">
              <p className="">
                For more than 150 years, ASPCA has been the leading voice in
                animal welfare, bringing the critical protection of animals to
                the forefront of society.
              </p>
              <p>
                They’ve led the way in fighting cruelty, rescuing and securing
                adoptions for animals in need, and driving significant
                legislative change that protects their lives and
                welfare—ultimately transforming how Americans value and care for
                animals.
              </p>
            </div>
          </div>
        </div>
        <div className="relative flex flex-col gap-4 bg-white px-16 py-20 rounded-3xl  w-1/2">
          ...
          <p className="text-3xl font-bold text-[#213430]">
            Help us respond promptly to nationwide animal crises
          </p>
          <p className="text-sm text-[#6F7775] leading-[2]">
            Your order will help us donate needed animal care products directly
            to ASPCA partner shelters, veterinary clinics, recovery centers and
            adoption centers
          </p>
          <div className="mt-4">
