...
export default function AmerianRedcross() {
  ...
  const handleNavigate = (item) => {
    ...
    router.push(
      `/product-details?category=${encodeURIComponent(
        query.category
  ...
  return (
    <div>
      <div
        ...
        style={{
          backgroundImage: "url('/assets/images/redCross.jpg')",
      ...
      >
        ...
        <div className="relative flex flex-col gap-5 my-10 w-1/2">
          ...
          <p className="text-white text-5xl font-bold animate-grow">
            Prevent and alleviate human suffering in Natural Disasters trees
          </p>
          <div className="flex gap-5 animate-grow">
            <hr className="w-2 h-72 border-0 bg-yellow-400" />
            <div className="flex flex-col gap-6 text-white font-medium">
              <p className="">
                The Red Cross shelters, feeds and provides comfort to people
                affected by disasters; supplies about 40% of the nation’s blood;
                teaches skills that save lives; distributes international
                humanitarian aid; and supports veterans, military members and
                their families.
              </p>
              <p>
                Through its strong network of volunteers, donors and partners,
                they are always there in times of need.
              </p>
              <p>
                Red Cross supporters provide a beacon of hope. From helping
                during disasters and ensuring access to lifesaving blood, to
                providing training to save lives and supporting military
                communities, the Red Cross is there when help can’t wait.
              </p>
            </div>
          </div>
        </div>
        <div className="relative flex flex-col gap-4 bg-white px-12 py-20 rounded-md my-20 w-1/2 animate-slideInFromRight">
          ...
          <p className="text-sm text-[#6F7775]">
            Every 8 minutes, someone affected by disaster is helped by donations
            to the Red Cross.
          </p>
          <p className="text-sm text-[#6F7775]">
            Each year, the generous support of donors like you enables their
            disaster workforce— 90% volunteers—to help millions of people in the
            U.S.
          </p>
          ...
          <div className="mt-4">
            ...
            <div className="w-full bg-gray-200 rounded-full h-4 my-2">
              <div
                className="flex items-center gap-20 bg-[#009368] h-4 rounded-full text-white px-5"
                style={{ width: "50%" }}
              >
                <p className="text-sm">$400</p>
                <p className="text-white text-sm">46%</p>
              </div>
            </div>
          </div>
        </div>
...
//     console.log(item);
//     // const query = JSON.stringify(item.id);
//     const query = { id: item.id, url: url };
